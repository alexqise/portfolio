...
import { AsciiBananaInline } from "./ascii-banana-inline";
...
export function V3Layout() {
  return (
    <div className="min-h-screen lg:h-screen lg:overflow-hidden flex flex-col">
      ...
      <main className="flex-1 lg:min-h-0 w-full px-4 sm:px-8 lg:pl-12 lg:pr-4 py-6 lg:py-8">
        <div className="h-full grid grid-cols-1 lg:grid-cols-[7fr_3fr] gap-5 lg:gap-3 items-start">
          {/* ── Left: Content ── */}
          <div className="lg:h-full lg:overflow-y-auto scrollbar-hidden pr-2 lg:pr-4 lg:flex lg:items-center">
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_4fr] gap-5 lg:gap-7 max-w-4xl mx-auto w-full">
      ...
      {/* Fixed bottom bar with version switcher + theme toggle */}
      <V3Footer />
    </div>
  );
}
