        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4">
              <SocialIcon href="https://x.com/alexqi" label="Twitter / X">
              ...
              <SocialIcon href="https://linkedin.com/in/alexqi" label="LinkedIn">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted">
                ...
                <li>
                  <span className="text-foreground">~ </span>
                  <Link href="#">drafted</Link> — agentic draft editor for
                  college essays, context on your extracurriculars and writing
                  style
                </li>
                <li>
                  <span className="text-foreground">~ </span>
                  <Link href="#">typr</Link> — real-time competitive
