    ...
    <div className="min-h-screen lg:h-screen lg:overflow-hidden flex flex-col">
      <main className="flex-1 lg:min-h-0 w-full px-4 sm:px-8 lg:pl-12 lg:pr-4 py-6 lg:py-8">
        <div className="h-full grid grid-cols-1 lg:grid-cols-[7fr_3fr] gap-5 lg:gap-3 items-start">
          <div className="lg:h-full lg:overflow-y-auto scrollbar-hidden pr-2 lg:pr-4 lg:flex lg:items-center w-full">
            <div className="mx-auto w-full max-w-[43.9rem] space-y-6 min-w-0">
          ...
          <div className="hidden lg:block h-full lg:-ml-16 lg:max-w-md lg:mt-8">
            <AsciiBananaInline />
          </div>
        </div>
      </main>
